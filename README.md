# ![nf-core/fastqtobam](docs/images/nf-core-fastqtobam_logo_light.png#gh-light-mode-only) ![nf-core/fastqtobam](docs/images/nf-core-fastqtobam_logo_dark.png#gh-dark-mode-only)
